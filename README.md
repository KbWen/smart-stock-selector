...
| 功能 | 說明 |
| :--- | :--- |
| **Ensemble V3 AI** | 結合三種異質機器學習模型，並整合 **Rise Score** 技術指標分數作為訓練特徵，穩定性提升。 |
| **Backtest Lab** | 「時光機」功能，可模擬過去 30 天的 AI 前 20 名選股表現，驗證策略有效性。 |
| **Smart Scan** | 複合式條件掃描，結合 AI 高勝率過濾與技術面（KD、MACD、成交量）訊號。 |
